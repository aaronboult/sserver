...
class ModuleTools:
    ...
    @classmethod
    def load_from_filename(cls, filename: str, package: str = None, folder_list: List[str] = None) -> List[ModuleType]:
    ...
    @classmethod
    def load_module(cls, path: str, package: str = None, suppress_errors: bool = True) -> ModuleType:
        """Load a module at `path` in `package`.
    ...
    @classmethod
    def get_app_name(cls, module_path: str) -> str:
